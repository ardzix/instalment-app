...
SECRET_KEY = '@lhh%5px=^8g5x9sqce!7@&9=!f4m)n^m1t5#ifo$zu4zhes%a'
...
COMPRESS_PRECOMPILERS = (
    ...
    ('text/jsx', 'cat {infile} | %s/bin/babel --presets es2015,react > {outfile}' % os.path.dirname(BASE_DIR)),
)
